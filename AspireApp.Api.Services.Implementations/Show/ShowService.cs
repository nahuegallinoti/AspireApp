...
public class ShowService(IShowDA showDA, ShowMapper mapper, HybridCache hybridCache) : 
    BaseService<Domain.Entities.Show, Models.App.Show, long>(showDA, mapper, hybridCache), IShowService
{
